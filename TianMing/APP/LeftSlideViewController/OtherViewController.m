...
- (void)createUI{
    ...
    if ([self.titleStr isEqualToString:@"关于我们"]) {
        UITextView * textView = [[UITextView alloc]initWithFrame:CGRectMake(10, 10, SCREEN_W-20, SCREEN_H-60) textContainer:nil];
        textView.text = @"        五州智运致力于整合\"物流服务、物流载体和物流需求\"三大资源，为众多物流企业提供\"信息交易、商务配套和物业\"等系统服务，是\"物流平台整合运营商和综合服务提供商\"。";
