...
- (void)createUI{
    ...
    UIScrollView*aBaseView=[[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, kWindowW, kWindowH)];
    baseView = aBaseView;
    ...
    [mutableArr addObject:@"tc1a"];
    [mutableArr addObject:@"tc1b"];
    [mutableArr addObject:@"tc2a"];
    [mutableArr addObject:@"tc2b"];
    [mutableArr addObject:@"tc3a"];
    [mutableArr addObject:@"tc3b"];
...
- (void)createETC{
    ...
    [applicationCertification setBackgroundImage:[UIImage imageNamed:@"blue_an1"] forState:UIControlStateNormal];
...
- (void)createCarSevice{
    ...
    [driverCodeBtn setBackgroundImage:[UIImage imageNamed:@"blue_an1"] forState:UIControlStateNormal];
    ...
    firstLine.backgroundColor = MAINCOLOR;
    ...
    [driverCodeBtn2 setBackgroundImage:[UIImage imageNamed:@"blue_an1"] forState:UIControlStateNormal];
    ...
    firstLine2.backgroundColor = MAINCOLOR;
